...
class AppConstants {
  static const String companyName = 'Rawabit';
  static const String appName = 'Rawabit Delivery';
  static const bool demo = false;
  static const int imageQuality = 100;
  static const String appVersion = '5.2';

  ///flutter SDK : 3.44.6
  static const String polylineMapKey = 'YOUR_MAP_KEY_HERE';

  static const String baseUrl = 'https://rawabit.online';
  ...
  static const String rescheduleOrderStatusUri =
      '/api/v2/delivery-man/update-expected-delivery';
  static const String pauseAndResumeOrderStatusUri =
      '/api/v2/delivery-man/order-update-is-pause';
  ...
  static const String deliveryWiseEarnedUri =
      '/api/v2/delivery-man/delivery-wise-earned';
  static const String orderListFilterByDate =
      '/api/v2/delivery-man/order-list-by-date';
  ...
  static const String messageListUri =
      '/api/v2/delivery-man/messages/get-message/';
  static const String sendMessageUri =
      '/api/v2/delivery-man/messages/send-message/';
  static const String withdrawListUri =
      '/api/v2/delivery-man/withdraw-list-by-approved';
  static const String emergencyContactList =
      '/api/v2/delivery-man/emergency-contact-list';
  static const String depositedList =
      '/api/v2/delivery-man/collected_cash_history';
  static const String forgotPassword =
      '/api/v2/delivery-man/auth/forgot-password';
  static const String verifyOtp = '/api/v2/delivery-man/auth/verify-otp';
  static const String resetPassword =
      '/api/v2/delivery-man/auth/reset-password';
  ...
  static const String deliveryVerificationImage =
      '/api/v2/delivery-man/order-delivery-verification';
  static const String otpVerificationForOrder =
      '/api/v2/delivery-man/verify-order-delivery-otp';
  static const String resendVerificationCode =
      '/api/v2/delivery-man/resend-verification-code';
  static const String setCurrentLanguageUri =
      '/api/v2/delivery-man/language-change';
  ...
  static const String maintenanceModeTopic =
      'maintenance_mode_start_deliveryman';
