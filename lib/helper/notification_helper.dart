  ...
  static Future<void> initialize(
              ...
              Navigator.of(Get.context!).pushReplacement(
                MaterialPageRoute(
                  builder: (_) => DashboardScreen(
                    pageIndex: 2,
                    chatIndex: payload.messageKey == 'message_from_customer'
                        ? 1
                        : payload.messageKey == 'message_from_seller'
                        ? 0
                        : 3,
                  ),
                ),
              ...
              Navigator.of(Get.context!).pushReplacement(
                MaterialPageRoute(
                  builder: (_) => OrderDetailsScreen(
                    orderModel: OrderModel(id: payload.orderId),
              ...
              Navigator.of(Get.context!).pushReplacement(
                MaterialPageRoute(
                  builder: (_) => WalletScreen(
                    fromNotification: true,
                    selectedIndex:
                        payload.messageKey == 'withdraw_request_status_message'
                        ? 1
                        : 0,
                  ),
                ),
                ...
                payload.messageKey == 'cash_collect_by_seller_message') {
              Navigator.of(Get.context!).pushReplacement(
                MaterialPageRoute(
                  builder: (_) => WalletScreen(
                    fromNotification: true,
              ...
              Navigator.of(Get.context!).pushReplacement(
                MaterialPageRoute(
                  builder: (_) => WalletScreen(
                    fromNotification: true,
                    selectedIndex:
                        payload.messageKey == 'cash_collect_by_admin_message'
                        ? 3
                        : 0,
                  ),
                ),
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      ...
      if (message.data['type'] == 'maintenance_mode') {
        ...
        if (config?.maintenanceModeData?.maintenanceStatus == 1 &&
          ...
          Navigator.of(Get.context!).pushReplacement(
            ...
            Get.currentRoute == 'MaintenanceScreen') {
      ...
      if (message.data['type'] == 'wallet' ||
          message.data['type'] == 'wallet_withdraw') {
