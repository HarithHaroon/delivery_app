            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Get.find<ThemeController>().darkTheme
                    ...
                    : Theme.of(context).cardColor.withValues(alpha: .09),
                border: Border.all(
                  color: Get.find<ThemeController>().darkTheme
                ...
                boxShadow: [
                  BoxShadow(
                    color: Get.find<ThemeController>().darkTheme
                        ? Theme.of(context).highlightColor
                        : Theme.of(context).cardColor.withValues(alpha: .02),
                    spreadRadius: 1,
                    blurRadius: 5,
                  ),
                ],
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    Text(
                      '${Get.find<SplashController>().myCurrency!.symbol} ${NumberFormat.compact().format(double.parse(PriceConverter.convertPriceWithoutSymbol(context, amount)))}',
