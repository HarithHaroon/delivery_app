...
import 'package:rawabit_delivery_app/common/basewidgets/flutter_custom_switch_widget.dart';
          ...
          builder: (orderController) {
            return (profileController.profileModel != null)
                ? FlutterCustomSwitchWidget(
                    width: showProfileImage ? 90 : 40,
                    height: showProfileImage ? 30 : 20,
                    valueFontSize: Dimensions.fontSizeDefault,
                    showOnOff: true,
                    activeText: showProfileImage ? 'online'.tr : '',
                    inactiveText: showProfileImage ? 'offline'.tr : '',
                    activeColor: showProfileImage
                        ...
                        : Theme.of(context).primaryColor,
                    activeTextColor: Theme.of(
                      context,
                    ).colorScheme.onTertiaryContainer.withValues(alpha: .75),
                    ...
                    activeIcon: showProfileImage
                        ? ClipRRect(
                            borderRadius: BorderRadius.circular(50),
                            child: CustomImageWidget(
                              image:
                                  '${Get.find<ProfileController>().profileModel!.imageFullUrl?.path}',
                              height: 30,
                              width: 30,
                              fit: BoxFit.cover,
                            ),
