...
import 'package:rawabit_delivery_app/features/profile/screens/bank_info_screen.dart';
                      ...
                      builder: (profileController) {
                        ...
                        if (accountNumber != null) {
                          if (accountNumber.length > 5) {
                            ...
                            lastPart = accountNumber.substring(
                        ...
                        String acNumber = accountNumber != null
                            ? '$firstPart****************$lastPart'
              ...
              builder: (withdrawController) {
                return Container(
                  ...
                  child: !withdrawController.isWithdraw
                      ? CustomButtonWidget(
                          onTap: () {
                            String withdrawAmount = amountController.text
                                .trim();
