...
import 'package:rawabit_delivery_app/features/notification/domain/models/notifications_model.dart';
...
class NotificationCardWidget extends StatelessWidget {
                    ...
                    ListTile(
                      ...
                      leading: Container(
                        ...
                        child: CustomAssetImageWidget(
                          Images.deliveryNotificationIcon,
                          color: isSeen ? Theme.of(context).hintColor : null,
                      ...
                      title: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              '${'order'.tr} # ${notificationModel!.orderId.toString()}',
                          ...
                          Text(
                            DateConverter.getLocalTimeWithAMPM(
                              notificationModel?.createdAt ?? '',
                            ),
                            style: rubikRegular.copyWith(
  ...
  bool _willShowDate(int index, List<Notifications>? notificationList) {
    ...
    final currentSupportTicketDate = DateTime.tryParse(
      currentSupportTicket.createdAt ?? '',
    );

    final previousSupportTicket = notificationList[index - 1];
    final previousSupportTicketDate = DateTime.tryParse(
      previousSupportTicket.createdAt ?? '',
    );
