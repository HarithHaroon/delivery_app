...
import 'package:rawabit_delivery_app/common/basewidgets/custom_image_widget.dart';
import 'package:rawabit_delivery_app/features/chat/controllers/chat_controller.dart';
import 'package:rawabit_delivery_app/features/chat/screens/media_viewer_screen.dart';
import 'package:rawabit_delivery_app/features/chat/widgets/chat_shimmer_widget.dart';
import 'package:rawabit_delivery_app/features/chat/widgets/message_list_view_widget.dart';
import 'package:rawabit_delivery_app/features/chat/widgets/message_sendig_section_widget.dart';
                    ...
                    Column(
                      children: [
                        chatController.messageModel != null
                            ? Expanded(
                                child:
                                    (chatController.messageModel!.message !=
                                            null &&
                                        chatController
                                            .messageModel!
                                            .message!
                                            .isNotEmpty)
                                    ? MessageListViewWidget(
                        ...
                        chatController.hasPicked
                            ? Container(
                                color:
                                    ...
                                    : null,
                                height:
                                    (chatController.pickedFIleCrossMaxLimit ||
                                        chatController
                                            .pickedFIleCrossMaxLength ||
                            ...
                            : (chatController
                                          ...
                                          ?.isNotEmpty ??
                                      false) &&
                                  chatController.isSending == false
                            ? Container(
                                color:
                                    chatController.isLoading == false &&
                                        ((chatController.pickedMediaFileModelList !=
                                ...
                                child: Column(
                                  ...
                                  children: [
                                                  ...
                                                  child: ClipRRect(
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: Image.file(
                                                        File(
                                                          chatController
                                                                  .pickedMediaFileModelList![index]
                                                                  .thumbnailPath ??
                                                              '',
                                                        ),
                                                        fit: BoxFit.cover,
                                                        ...
                                                        onTap: () => Navigator.push(
                                                          ...
                                                          MaterialPageRoute(
                                                            builder: (_) => MediaViewerScreen(
                                                              clickedIndex:
                                                                  index,
                                                              localMedia: chatController
                                                                  .getXFileFromMediaFileModel(
                                                                    chatController
                                                                            .pickedMediaFileModelList ??
                                                                        [],
                                                                  ),
                                    ...
                                    if (chatController
                                            .pickedFIleCrossMaxLimit ||
                                        chatController
                                            .pickedImageCrossMaxLength ||
                                        chatController.singleFIleCrossMaxLimit)
                                      Text(
                                        "${chatController.pickedImageCrossMaxLength ? "• ${"can_not_select_more_than".tr} ${AppConstants.maxLimitOfTotalFileSent.floor()} ${'files'.tr}" : ""} "
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: Padding(
                                          ...
                                          child: ListView.separated(
                                            ...
                                            itemBuilder: (context, index) {
                                              String fileSize =
                                                  ImageValidationHelper.getFileSizeFromPlatformFileToString(
                                                    chatController
                                                        .pickedFiles![index],
                                                  );
                                              return Container(
                                      ...
                                      if (chatController
                                          ...
                                          chatController
                                              .pickedFIleCrossMaxLength ||
                                          chatController
                                              .singleFIleCrossMaxLimit)
                                        Text(
                                          "${chatController.pickedFIleCrossMaxLength ? "• ${"can_not_select_more_than".tr} ${AppConstants.maxLimitOfTotalFileSent.floor()} ${'files'.tr}" : ""} "
                                          "${chatController.pickedFIleCrossMaxLimit ? "• ${'total_images_size_can_not_be_more_than'.tr} ${AppConstants.maxLimitOfFileSentINConversation.floor()} MB" : ""} "
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      height: chatController.isSending
                                          ? 25.0
                                          : 0.0,
                                      child: Padding(
                                        padding: EdgeInsets.only(
                        ...
                        chatController.isLoading == false &&
                                ((chatController.pickedMediaFileModelList !=
                                        ...
                                        chatController
                                            .pickedMediaFileModelList!
                                            .isNotEmpty) ||
                                    (chatController.pickedFiles != null &&
                                        chatController.pickedFiles!.isNotEmpty))
