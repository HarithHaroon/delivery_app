...
import 'package:rawabit_delivery_app/features/chat/widgets/custom_image_pick_bottom_sheet.dart';
...
class MessageSendingSectionWidget extends StatefulWidget {
  ...
  @override
  State<MessageSendingSectionWidget> createState() =>
      _MessageSendingSectionWidgetState();
}

class _MessageSendingSectionWidgetState
    extends State<MessageSendingSectionWidget> {
  ...
  bool _isMsgValid(ChatController chatController) {
    bool isImageMsgValid =
        (chatController.pickedMediaFileModelList?.isNotEmpty ?? false) &&
        !chatController.pickedImageCrossMaxLength;
    bool isFileMsgValid =
        (chatController.pickedFiles?.isNotEmpty ?? false) &&
        !chatController.pickedFIleCrossMaxLength;
    bool isTextMsgValid =
        _inputMessageController.text.trim().isNotEmpty &&
        !chatController.pickedImageCrossMaxLength &&
        !chatController.pickedFIleCrossMaxLength;
    return (isImageMsgValid || isFileMsgValid || isTextMsgValid) &&
