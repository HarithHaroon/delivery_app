...
import 'package:rawabit_delivery_app/features/order/domain/models/date_type.dart';
...
class _RefundFilterActionState extends State<RefundFilterAction> {
                      ...
                      CustomCalendarWidget(
                        ...
                        onSubmit: (PickerDateRange? range) {
                          if (range?.startDate == null) {
                            ...
                            orderController.setOrderTypeIndex(
                              orderController.orderTypeIndex,
                              startDate: orderController.startDate ?? '',
                              endDate: orderController.endDate ?? '',
                              search: '',
                              reload: false,
                              isUpdate: true,
                            );
  ...
  PopupMenuItem<DateType> _buildPopupItem(
              ...
              IconButton(
                ...
                onPressed: () {
                  if (controller.text.trim().isNotEmpty &&
                      orderController.isSearchActive) {
                    controller.text = '';
                    orderController.setOrderTypeIndex(
                      orderController.orderTypeIndex,
                      startDate: orderController.startDate ?? '',
                      ...
                      suffixIcon: InkWell(
                        ...
                        onTap: () {
                          if (orderController.isSearchActive) {
                            orderController.setSearchStatus(
                              !orderController.isSearchActive,
                              isUpdate: true,
                            );
                            controller.text = '';
