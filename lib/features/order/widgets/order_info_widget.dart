...
import 'package:rawabit_delivery_app/features/order_details/widgets/order_status_widget.dart';
        ...
        children: [
          ...
          Column(
            children: [
              OrderItemInfoWidget(
                title: 'order_id',
                info: '#${orderModel!.id.toString()}',
                textStyle: rubikMedium.copyWith(
                  color: Get.isDarkMode
                      ? Theme.of(context).hintColor
                      : Theme.of(
                          context,
                        ).textTheme.bodyLarge?.color?.withValues(alpha: 0.60),
              ...
              OrderItemInfoWidget(
                title: 'order_placed',
                info: orderModel!.updatedAt.toString(),
                isDate: true,
                textStyle: rubikMedium.copyWith(
                  color: Get.isDarkMode
                      ? Theme.of(context).hintColor
              ...
              OrderItemInfoWidget(
                title: 'products',
                info: orderController!.orderDetails!.length.toString(),
                isProduct: true,
              ),
            ],
          ),
