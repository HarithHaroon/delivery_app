...
import 'package:rawabit_delivery_app/features/order_details/widgets/cal_chat_widget.dart';
...
class OrderHistoryItemWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    String customerName = orderModel!.isGuest!
    ...
    return GestureDetector(
      onTap: () => Get.to(
        OrderDetailsScreen(orderModel: orderModel, fromNotification: false),
      ),
      child: Container(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              ...
                              : orderModel?.orderStatus?.tr == 'Delivered'
                              ? Theme.of(context)
                                    .colorScheme
                                    .onTertiaryContainer
