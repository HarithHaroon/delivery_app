...
class OrderModel {
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    billingAddress = json['billing_address_data'] != null
        ? ShippingAddress.fromJson(json['billing_address_data'])
        : null;
    sellerInfo = json['seller'] != null
    ...
    referAndEarnDiscount = double.tryParse(
      json['refer_and_earn_discount'].toString(),
    );
...
class SellerInfo {
  ...
  SellerInfo({this.id, this.shop, this.phone, this.email});
