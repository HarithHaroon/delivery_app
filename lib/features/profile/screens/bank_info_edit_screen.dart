...
class _BankInfoEditScreenState extends State<BankInfoEditScreen> {
  ...
  void initState() {
    _accountNameController.text =
        Get.find<ProfileController>().profileModel!.holderName ?? '';
    _bankNameController.text =
        Get.find<ProfileController>().profileModel!.bankName ?? '';
    _branchNameController.text =
        Get.find<ProfileController>().profileModel!.branch ?? '';
    _accountNumberController.text =
        Get.find<ProfileController>().profileModel!.accountNo ?? '';
    super.initState();
  }
                        ...
                        onTap: () {
                          ...
                          if (accountName.isEmpty) {
                            showCustomSnackBarWidget(
                              'account_name_is_required'.tr,
                            );
                          } else if (bankName.isEmpty) {
                            showCustomSnackBarWidget(
                              'bank_name_is_required'.tr,
                            );
                          } else if (branchName.isEmpty) {
                            showCustomSnackBarWidget(
                              'branch_name_is_required'.tr,
                            );
                          } else if (accountNumber.isEmpty) {
                            showCustomSnackBarWidget(
                              'account_number_is_required'.tr,
                            );
                          } else {
