...
class ProfileService implements ProfileServiceInterface {
  ...
  Future<Response> resetPassword(
    ...
    Response response = await profileRepoInterface.resetPassword(
      phone,
      password,
      confirmPassword,
    );
  ...
  Future<ResponseModel> updateProfile(
    ...
    http.StreamedResponse response = await profileRepoInterface.updateProfile(
      updateUserModel,
      pass,
      file,
      token,
  ...
  Future<Response> updateBankInfo({
    ...
    Response response = await profileRepoInterface.updateBankInfo(
      bankName: bankName,
      branch: branch,
