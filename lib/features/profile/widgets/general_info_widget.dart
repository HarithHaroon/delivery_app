...
import 'package:rawabit_delivery_app/common/basewidgets/custom_text_field_widget.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextFieldWidget(
                    ...
                    fillColor: Theme.of(
                      context,
                    ).hintColor.withValues(alpha: .125),
                    isShowBorder: true,
                    isDisable: false,
                    inputType: TextInputType.name,
                  ...
                  CustomTextFieldWidget(
                    ...
                    hintText:
                        '${profileController.profileModel!.countryCode ?? ""} ${profileController.profileModel!.phone ?? ""}',
                  ),
                  SizedBox(height: Dimensions.paddingSizeSmall),
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextFieldWidget(
                    ...
                    inputType: TextInputType.number,
                    hintText:
                        '${profileController.profileModel!.identityNumber} (${profileController.profileModel!.identityType})',
                  ),

                  profileController.profileModel!.identityImageFullUrl !=
                              null &&
                          (profileController
                                      .profileModel!
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CustomImageWidget(
                                      image:
                                          '${profileController.profileModel!.identityImageFullUrl![0].path}',
                                      height: 120,
                                    ),
                                  ),
                                ),
                                  ...
                                  ? Expanded(
                                      child: Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: CustomImageWidget(
                                            image:
                                                '${profileController.profileModel!.identityImageFullUrl![1].path}',
                                            height: 120,
                                          ),
                                        ),
                                      ),
                  ...
                  profileController.profileModel!.identityImageFullUrl!.length >
                          2
                      ? Padding(
                          padding: EdgeInsets.symmetric(
                            vertical: Dimensions.paddingSizeDefault,
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CustomImageWidget(
                                      image:
                                          '${profileController.profileModel!.identityImageFullUrl![2].path}',
                                      height: 120,
                                    ),
                                  ),
                                ),
                                  ...
                                  ? Expanded(
                                      child: Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: CustomImageWidget(
                                            image:
                                                '${profileController.profileModel!.identityImageFullUrl![3].path}',
                                            height: 120,
                                          ),
                                        ),
                                      ),
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CustomImageWidget(
                                      image:
                                          '${profileController.profileModel!.identityImageFullUrl![4].path}',
                                      height: 120,
                                    ),
                                  ),
                                ),
