...
import 'package:rawabit_delivery_app/features/earning_statement/widgets/earning_statement_card_widget.dart';
            ...
            ? walletController!.deliveryWiseEarned.isNotEmpty
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          EarningStatementCardWidget(
                            ordersWiseEarned:
                                walletController!.deliveryWiseEarned[index],
                          ),
                    )
                  : Padding(
                      padding: EdgeInsets.only(top: Dimensions.splashLogoWidth),
                      child: NoDataScreenWidget(
                        noDataImage: Images.noTransactionAvailableIcon,
                        noDataMessage: 'no_transaction_available'.tr,
                      ),
                    )
