...
import 'package:rawabit_delivery_app/common/basewidgets/custom_action_button_widget.dart';
                  ...
                  children: [
                    Padding(
                      ...
                      child: const SizedBox(
                        width: 20,
                        child: CustomAssetImageWidget(Images.cash),
                      ),
                    ),
                    Text(
                      '${'by'.tr} ${'cash'.tr}',
                ...
                children: [
                  ...
                  Text(
                    PriceConverter.convertPrice(
                      ordersWiseEarned!.deliverymanCharge,
                    ),
                  ),
                ],
              ),
