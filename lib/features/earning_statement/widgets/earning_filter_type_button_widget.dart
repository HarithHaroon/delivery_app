...
class EarningFilterTypeButtonWidget extends StatelessWidget {
  final String text;
  final int index;
  const EarningFilterTypeButtonWidget({
    super.key,
    required this.text,
    required this.index,
  });
          ...
          return Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: order.orderTypeFilterIndex == index
                    ? Get.isDarkMode
              ...
              child: Text(
                text,
                style: order.orderTypeFilterIndex == index
                    ? rubikMedium.copyWith(
                        color: order.orderTypeFilterIndex == index
                            ? Colors.white
                            : Theme.of(context).textTheme.bodyLarge as Color?,
                      )
