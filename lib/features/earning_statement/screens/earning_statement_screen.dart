...
import 'package:rawabit_delivery_app/features/earning_statement/widgets/earning_filter_button_widget.dart';
import 'package:rawabit_delivery_app/features/earning_statement/widgets/earning_statement_list_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          Get.find<WalletController>().setEarningFilterIndex(
            Get.find<WalletController>().orderTypeFilterIndex,
          );
        },
                ...
                children: [
                  GetBuilder<WalletController>(
                    builder: (walletController) {
                      return EarningStatementListViewWidget(
