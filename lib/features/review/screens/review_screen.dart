...
import 'package:rawabit_delivery_app/features/review/widgets/review_card_shimmer_widget.dart';
import 'package:rawabit_delivery_app/features/review/widgets/review_filter_widget.dart';
import 'package:rawabit_delivery_app/features/review/widgets/review_list_widget.dart';
          ...
          body: Column(
            children: [
              ...
              !reviewController.isLoading &&
                      reviewController.reviewModel != null
                  ? (reviewController.reviewModel!.review != null &&
                            reviewController.reviewModel!.review!.isNotEmpty)
                        ? Expanded(
                  ...
                  : const Expanded(child: ReviewCardShimmerWidget()),
            ],
          ),
        );
      },
