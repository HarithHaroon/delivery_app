...
import 'package:rawabit_delivery_app/features/review/domain/models/review_model.dart';
              ...
              children: [
                            ...
                            Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: CustomImageWidget(
                                  image:
                                      '${review!.customer!.imageFullUrl?.path}',
                                  height: 30,
                                  width: 30,
                                ),
                              ),
                ...
                Padding(
                  ...
                  child: ReadMoreText(
                    ...
                    lessStyle: rubikBold.copyWith(
                      fontSize: Dimensions.fontSizeSmall,
                      color: Get.isDarkMode
                          ? Theme.of(context).hintColor.withValues(alpha: .5)
                          : Theme.of(context).primaryColor,
                    ),
                    moreStyle: rubikBold.copyWith(
                      fontSize: Dimensions.fontSizeSmall,
                      color: Get.isDarkMode
                          ? Theme.of(context).hintColor.withValues(alpha: .5)
                          : Theme.of(context).primaryColor,
                      ...
                      GetBuilder<ReviewController>(
                        builder: (reviewController) {
                          return GestureDetector(
                            onTap: () => reviewController.savedReview(
                              review!.id,
                              review!.isSaved == 1 ? 0 : 1,
                              index,
                            ),
                            child: Icon(
                              review!.isSaved == 1
