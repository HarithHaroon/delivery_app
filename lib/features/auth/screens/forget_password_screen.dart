...
import 'package:rawabit_delivery_app/features/auth/screens/otp_verification_screen.dart';
...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  void initState() {
    isEmailVerification =
        Get.find<SplashController>().configModel?.forgotPasswordVerification ==
        'email';
              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    color: Get.isDarkMode
                        ? Theme.of(context).primaryColor.withValues(alpha: .02)
                        : Theme.of(context).primaryColor.withValues(alpha: .02),
                  ),
                  child: Stack(
                    children: [
                        ...
                        children: [
                            ...
                            SizedBox(
                              ...
                              child: Padding(
                                ...
                                child: CodePickerWidget(
                                  ...
                                  initialSelection: isEmailVerification
                                      ? null
                                      : _countryDialCode,
                          ...
                          Expanded(
                            child: CustomTextFieldWidget(
                              hintText: isEmailVerification
                                  ? 'enter_email_address'.tr
                                  : 'enter_phone_number'.tr,
                              controller: _numberController,
                              focusNode: _numberFocus,
                              noPadding: true,
                              inputType: isEmailVerification
                          ...
                          onTap: () {
                            ...
                            if (_numberController.text.isEmpty) {
                              showCustomSnackBarWidget(
                                ...
                                !isEmail(_numberController.text.trim())) {
                              showCustomSnackBarWidget(
