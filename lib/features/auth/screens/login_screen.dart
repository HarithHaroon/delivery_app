...
import 'package:rawabit_delivery_app/features/auth/screens/forget_password_screen.dart';
import 'package:rawabit_delivery_app/features/auth/widgets/code_picker_widget.dart';
                ...
                children: [
                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              '${'welcome_to'.tr} ${AppConstants.companyName}',
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          'to_reach_your_customer_destination'.tr,
                  ...
                  Container(
                    decoration: BoxDecoration(
                      ...
                      color: Get.isDarkMode
                          ? Theme.of(
                              context,
                            ).primaryColor.withValues(alpha: .02)
                          : Theme.of(
                              context,
                            ).primaryColor.withValues(alpha: .02),
                    ),
                  ...
                  !authController.isLoading
                      ? CustomButtonWidget(
                          btnTxt: 'login'.tr,
                          onTap: () async {
                            String countryCode = Get.find<AuthController>()
                                .countryCode
                                .replaceAll('+', '');
                            ...
                            if (phone.isEmpty) {
                              ...
                              await authController
                                  .login(countryCode, phone, _password)
                                  .then((status) async {
                                    if (status.isSuccess) {
