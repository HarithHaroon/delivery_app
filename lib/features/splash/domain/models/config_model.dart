import 'package:rawabit_delivery_app/data/models/image_full_url.dart';
import 'package:rawabit_delivery_app/features/chat/domain/enums/vacation_duration_type.dart';
...
class ConfigModel {
  ...
  DeliveryManAppVersionControl? get deliveryManAppVersionControl =>
      _deliveryManAppVersionControl;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['decimal_point_settings'] != null &&
      ...
      _decimalPointSetting = int.parse(
        json['decimal_point_settings'].toString(),
      );
    }
    ...
    decimalPointSettings = int.tryParse(
      json['decimal_point_settings'].toString(),
    );
    ...
    if (json['inhouse_temporary_close'] != null) {
      _inHouseTemporaryClose = InHouseVacationAdd.fromJson(
        json['inhouse_temporary_close'],
      );
    } else {
    ...
    if (json['inhouse_vacation_add'] != null) {
      _inHouseVacationAdd = InHouseVacationAdd.fromJson(
        json['inhouse_vacation_add'],
      );
    } else {
    ...
    if (json['delivery_man_app_version_control'] != null) {
      _deliveryManAppVersionControl = DeliveryManAppVersionControl.fromJson(
    ...
    systemImageFileUploadMaxSize = int.tryParse(
      json['system_image_file_upload_max_size'].toString(),
    );
    systemGeneralFileUploadMaxSize = int.tryParse(
      json['system_general_file_upload_max_size'].toString(),
    );
  }
}
...
class InHouseVacationAdd {
  ...
  InHouseVacationAdd.fromJson(Map<String, dynamic> json) {
    ...
    vacationStartDate = DateTime.tryParse(
      json['vacation_start_date'].toString(),
    );
    vacationEndDate = DateTime.tryParse(json['vacation_end_date'].toString());
    vacationNote = json['vacation_note'];
    if (json['vacation_duration_type'] != null) {
      vacationDurationType = VacationDurationType.fromJson(
        json['vacation_duration_type'],
      );
    }
  }
}
...
class InHouseShop {
  ...
  factory InHouseShop.fromJson(Map<String, dynamic> json) => InHouseShop(
    ...
    vacationDurationType: int.tryParse(
      json['vacation_duration_type'].toString(),
    ),
...
class DeliveryManAppVersionControl {
  ...
  Map<String, dynamic> toJson() {
    return {'for_android': forAndroid.toJson(), 'for_ios': forIos.toJson()};
  }
}
...
class AppVersion {
  ...
  AppVersion({required this.status, required this.version, required this.link});
  ...
  Map<String, dynamic> toJson() {
    return {'status': status, 'version': version, 'link': link};
  }
}
