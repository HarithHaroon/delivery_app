...
class OrderDetailsRepository implements OrderDetailsRepositoryInterface {
  ...
  @override
  Future<Response> rescheduleOrder({
    int? orderId,
    String? deliveryDate,
    String? cause,
  }) async {
    Response response = await apiClient
        .postData(AppConstants.rescheduleOrderStatusUri, {
          "order_id": orderId,
  ...
  @override
  Future<Response> pauseAndResumeOrder({
    int? orderId,
    int? isPos,
    String? cause,
  }) async {
  ...
  Future<Response> uploadOrderVerificationImage(
    ...
    Map<String, String> fields = <String, String>{'order_id': orderId};
  ...
  Future<Response> verifyOrderDeliveryOtp({
    ...
    Response response = await apiClient.postData(
      ...
      {"order_id": orderId, "verification_code": verificationCode},
    );
    return response;
  }
