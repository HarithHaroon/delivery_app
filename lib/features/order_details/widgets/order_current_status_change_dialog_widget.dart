...
import 'package:rawabit_delivery_app/common/basewidgets/custom_date_picker_widget.dart';
...
class OrderStatusUpdateDialogWidget extends StatefulWidget {
  ...
  const OrderStatusUpdateDialogWidget({
    super.key,
    required this.icon,
    this.title,
  ...
  @override
  State<OrderStatusUpdateDialogWidget> createState() =>
      _OrderStatusUpdateDialogWidgetState();
}

class _OrderStatusUpdateDialogWidgetState
    extends State<OrderStatusUpdateDialogWidget> {
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(
                      widget.icon,
                      width: Get.context!.width <= 400 ? 20 : 50,
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: CustomDatePickerWidget(
                        ...
                        textColor: orderController.startDate == null
                    ...
                    : Padding(
                        ...
                        child: Container(
                          ...
                          child: DropdownButton<String>(
                            ...
                            items: orderController.reasonList.map((
                              String value,
                            ) {
