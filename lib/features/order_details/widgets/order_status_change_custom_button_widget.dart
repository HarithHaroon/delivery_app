...
import 'package:rawabit_delivery_app/common/basewidgets/custom_loader_widget.dart';
...
import 'package:rawabit_delivery_app/features/order_details/widgets/slider_button_widget.dart';
...
class OrderStatusChangeCustomButtonWidget extends StatelessWidget {
  ...
  const OrderStatusChangeCustomButtonWidget({
    super.key,
    this.orderModel,
    this.index,
    this.showCollectAmount,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return (orderModel!.orderStatus == 'processing' ||
                              ...
                              children: [
                                ...
                                Text(
                                  PriceConverter.convertPrice(
                                    orderDetailsController.totalPrice,
                                  ),
                  ...
                  child: SliderButtonWidget(
                    ...
                    label: Text(
                      orderModel!.orderStatus == 'processing'
                          ? 'swipe_to_out_for_delivery_order'.tr
