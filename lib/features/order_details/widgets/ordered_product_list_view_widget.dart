...
class OrderedItemProductListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: orderController!.orderDetails!.length == 1
          ? 185
          : orderController!.orderDetails!.length < 5
          ? (185 + (60 * orderController!.orderDetails!.length - 1))
          : 595,
      child: Container(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                SizedBox(
                                  height:
                                      Dimensions.productImageSizeOrderDetails,
                                  width:
                                      Dimensions.productImageSizeOrderDetails,
                                  child: ClipRRect(
                                    ...
                                    child: CustomImageWidget(
                                      image:
                                          '${orderController!.orderDetails![index].productDetails!.thumbnailFullUrl?.path}',
                                      height: Dimensions
                                          .productImageSizeOrderDetails,
                                      width: Dimensions
                                          .productImageSizeOrderDetails,
                                      fit: BoxFit.cover,
                                    ),
