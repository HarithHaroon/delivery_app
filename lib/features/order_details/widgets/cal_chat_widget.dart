...
import 'package:rawabit_delivery_app/features/order_details/widgets/round_border_icon_widget.dart';
...
class CallAndChatWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isAdmin) {
      ...
      id = isSeller
          ? orderModel!.sellerInfo!.id!
          : orderModel!.customer?.id ?? -1;
      name = isSeller
      ...
      image = isSeller
          ...
          : orderModel?.customer?.imageFullUrl?.path;
    }
    ...
    return Row(
      children: [
                  ...
                  () => ChatScreen(
                    ...
                    isShopOnVacation: isSeller
                        ? ShopHelper.isVacationActive(
                            context,
                            startDate:
                                orderModel?.sellerInfo?.shop?.vacationStartDate,
                            endDate:
                                orderModel?.sellerInfo?.shop?.vacationEndDate,
                            vacationDurationType: orderModel
                                ?.sellerInfo
                                ?.shop
                                ?.vacationDurationType,
                            vacationStatus:
                                orderModel?.sellerInfo?.shop?.vacationStatus,
        ...
        InkWell(
          ...
          child: const RoundBorderIconWidget(image: Images.callIcon),
        ),
      ],
    );
  }
