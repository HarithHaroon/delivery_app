...
import 'package:rawabit_delivery_app/features/dashboard/screens/dashboard_screen.dart';
import 'package:rawabit_delivery_app/features/order/controllers/order_controller.dart';
import 'package:rawabit_delivery_app/features/order/widgets/order_info_widget.dart';
import 'package:rawabit_delivery_app/features/order_details/controllers/order_details_controller.dart';
import 'package:rawabit_delivery_app/features/order_details/domain/models/order_details_model.dart';
import 'package:rawabit_delivery_app/features/order_details/screens/order_delivered_screen.dart';
import 'package:rawabit_delivery_app/features/order_details/widgets/camera_or_gallery_widget.dart';
import 'package:rawabit_delivery_app/features/order_details/widgets/change_amount_widget.dart';
import 'package:rawabit_delivery_app/features/order_details/widgets/delivery_info_widget.dart';
import 'package:rawabit_delivery_app/features/order_details/widgets/order_details_shimmer_widget.dart';
import 'package:rawabit_delivery_app/features/order_details/widgets/order_info_with_customer_widget.dart';
import 'package:rawabit_delivery_app/features/order_details/widgets/order_status_change_custom_button_widget.dart';
import 'package:rawabit_delivery_app/features/order_details/widgets/payment_info_widget.dart';
import 'package:rawabit_delivery_app/features/order_details/widgets/seller_info_widget.dart';
import 'package:rawabit_delivery_app/features/order_details/widgets/verify_otp_sheet_widget.dart';
import 'package:rawabit_delivery_app/features/splash/controllers/splash_controller.dart';
import 'package:rawabit_delivery_app/features/splash/domain/models/config_model.dart'
    as config;
...
import 'package:rawabit_delivery_app/common/basewidgets/custom_title_widget.dart';
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
              ...
              return GetBuilder<OrderDetailsController>(
                builder: (orderDetailsController) {
                  if (orderDetailsController.endOfPage &&
                      !orderDetailsController.endOfPageScrolled) {
                    _scrollDown();
                  }
                  ...
                  if (orderModel?.orderStatus != null) {
                    ...
                    if (orderDetailsController.orderDetails != null) {
                      ...
                      for (var orderDetails
                          in orderDetailsController.orderDetails!) {
                        _itemsPrice =
                            _itemsPrice +
                    ...
                    _subTotal =
                        _itemsPrice + _tax - _discount - _referAndEarnDiscount;

                    if (editOrderPayment()) {
                      orderDetailsController.setTotalPrice =
                                ...
                                children: [
                                  orderModel!.orderStatus == 'processing' ||
                                          orderModel!.orderStatus ==
                                              'out_for_delivery'
                                      ? OrderInfoWithDeliveryInfoWidget(
                                          orderModel: orderModel,
                                        )
                                      : const SizedBox(),
                                  ...
                                  PaymentInfoWidget(
                                    ...
                                    deliveryCharge:
                                        orderModel?.isShippingFree ?? false
                                        ? 0
                                        : deliveryCharge,
                                    totalPrice: _total,
                                    paidAmount: editOrderPayment()
                                        ? (_total -
                                              _editOrderCollectableAmount!)
                                        : 0,
                                    dueAmount: editOrderPayment()
                                        ? (_editOrderCollectableAmount!)
                                        : 0,
                                  ),
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Expanded(
                                            child: Text(
                                              'additional_delivery_charge_by_admin'
                                                  .tr,
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          const CustomTitleWidget(
                                            title: 'completed_service_picture',
                                          ),
                                          Padding(
          ...
          builder: (orderController) {
            return GetBuilder<OrderDetailsController>(
              builder: (orderDetailsController) {
                ...
                final hasNoVerificationAndNoUpload =
                    config?.orderVerification == 0 && config?.imageUpload == 0;
  ...
  void _handleImageUploadFlow(
    ...
    if (orderDetailsController.identityImages.isEmpty) {
      ...
      orderDetailsController
          .uploadOrderVerificationImage(orderModel!.id.toString())
          .then((value) {
            if (value.statusCode == 200) {
              _handlePostUploadFlow(
                Get.context!,
                orderDetailsController,
                orderModel,
              );
  ...
  void _handlePostUploadFlow(
    ...
    if (splashController.configModel?.orderVerification == 1) {
      _showVerificationBottomSheet(
        context,
        orderModel,
        orderDetailsController.totalPrice ?? 0,
      );
    } else {
  ...
  bool editOrderPayment() =>
      ((orderDetails?.latestEditHistory?.orderDueAmount ?? 0) > 0 &&
      (orderDetails?.latestEditHistory?.orderDuePaymentStatus == 'unpaid' &&
          orderDetails?.latestEditHistory?.orderDuePaymentMethod ==
              'cash_on_delivery'));
