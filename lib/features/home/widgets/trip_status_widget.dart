            ...
            children: [
              ...
              GestureDetector(
                ...
                child: TripItem(
                  ...
                  title: 'assigned',
                  totalCount: profileController.profileModel != null
                      ? profileController.profileModel!.totalDelivery ?? 0
                      : 0,
                  onTap: () {
                    Get.find<DashboardController>().selectOrderHistoryScreen(
                      fromHome: true,
                    );
              ...
              TripItem(
                ...
                icon: Images.pending,
                title: 'paused',
                totalCount: profileController.profileModel?.pauseDelivery ?? 0,
                onTap: () {
                  Get.find<DashboardController>().selectOrderHistoryScreen(
                    fromHome: true,
                  );
              ...
              TripItem(
                ...
                title: 'delivered',
                totalCount:
                    profileController.profileModel?.completedDelivery ?? 0,
                onTap: () {
                  Get.find<DashboardController>().selectOrderHistoryScreen(
                    fromHome: true,
                  );
...
class TripItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Padding(
        padding: EdgeInsets.only(top: Dimensions.paddingSizeChat),
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: Theme.of(
                  context,
                ).textTheme.bodyLarge!.color!.withValues(alpha: .11),
                spreadRadius: 0,
                blurRadius: 4,
