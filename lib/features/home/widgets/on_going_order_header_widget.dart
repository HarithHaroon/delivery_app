...
import 'package:rawabit_delivery_app/features/order_details/widgets/customer_info_widget.dart';
...
class OngoingOrderHeaderWidget extends StatelessWidget {
  ...
  const OngoingOrderHeaderWidget({
    super.key,
    this.orderModel,
    this.index,
  ...
  Widget build(BuildContext context) {
    String timeAgo = timeago.format(
      DateConverter.isoStringToLocalDate(orderModel!.createdAt!),
    );
              ...
              Row(
                children: [
                  SizedBox(
                    width: Dimensions.iconSizeDefault,
                    child: Image.asset(
                      isExpanded ? Images.sellerIconExpand : Images.sellerIcon,
                    ),
                  ),
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                orderModel?.sellerIs == 'admin'
                                    ? inHouseShop?.address ?? ''
                                    : orderModel!.sellerInfo?.shop?.address ??
                                          '',
                                maxLines: 2,
