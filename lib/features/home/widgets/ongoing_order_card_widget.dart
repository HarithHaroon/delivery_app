...
import 'package:rawabit_delivery_app/features/home/widgets/on_going_order_header_widget.dart';
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        Get.find<OrderController>().selectedOrderLatLng(
                          orderModel?.shippingAddress?.latitude ?? '23',
                          orderModel?.shippingAddress?.longitude ?? '90',
                        );
                      },
                      child: OngoingOrderHeaderWidget(
                        orderModel: orderModel,
                        index: index,
                        isExpanded: true,
                      ),
