...
import 'package:rawabit_delivery_app/common/basewidgets/calculation_widget.dart';
            ...
            return Container(
              decoration: BoxDecoration(
                color: Get.find<ThemeController>().darkTheme
                    ...
                    : Theme.of(context).primaryColor.withValues(alpha: .91),
                borderRadius: BorderRadius.only(
                  bottomLeft: Radius.circular(Dimensions.paddingSizeOverLarge),
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Padding(
                      padding: EdgeInsets.only(
                        ...
                        left: Dimensions.fontSizeHeading,
                        right: Dimensions.rememberMeSizeDefault,
                        ...
                        children: [
                          Container(
                            decoration: BoxDecoration(
                              color: Theme.of(
                                context,
                              ).primaryColorLight.withValues(alpha: .25),
                              border: Border.all(
                            ...
                            child: ClipRRect(
                              ...
                              child: CustomImageWidget(
                                image:
                                    '${Get.find<ProfileController>().profileImage}',
                                height: 40,
                                width: 40,
                                fit: BoxFit.cover,
                              ),
                          ...
                          Column(
                            ...
                            children: [
                              if (Get.find<ProfileController>().profileModel !=
                                  null)
                                Padding(
                                  padding: EdgeInsets.fromLTRB(
                                    Dimensions.paddingSizeSmall,
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                      left: Dimensions.rememberMeSizeDefault,
                    ),
                    child: SizedBox(
                      height: 100,
                      child: Row(
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                      left: Dimensions.fontSizeHeading,
                      right: Dimensions.fontSizeHeading,
                    ),
                    child: Row(
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              '${Get.find<SplashController>().myCurrency!.symbol} ${NumberFormat.compact().format(double.parse(PriceConverter.convertPriceWithoutSymbol(context, profileController.profileModel?.withdrawableBalance ?? 0)))}',
