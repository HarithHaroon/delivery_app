  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: transactionTypeModel?.index == selectedIndex
            ? Get.isDarkMode
        ...
        child: Column(
          ...
          children: [
            SizedBox(
              width: 30,
              child: Image.asset(
                transactionTypeModel!.icon,
                color: Get.isDarkMode
                    ? Theme.of(context).primaryColorLight
                    : transactionTypeModel!.index == selectedIndex
                    ? Theme.of(context).cardColor
                    : Theme.of(context).primaryColor,
              ),
            ),
