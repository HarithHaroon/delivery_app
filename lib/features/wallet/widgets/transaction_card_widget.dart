...
import 'package:rawabit_delivery_app/common/basewidgets/custom_divider_widget.dart';
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              SizedBox(
                ...
                child: Image.asset(Images.assigned),
              ),
              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    ...
                    color: Theme.of(
                      context,
                    ).colorScheme.onTertiaryContainer.withValues(alpha: .1),
                  ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        ' ${PriceConverter.convertPrice(orders.deliverymanCharge)}',
                        style: rubikMedium.copyWith(
                          color: Theme.of(
                            context,
                          ).colorScheme.onTertiaryContainer,
          ...
          Padding(
            ...
            child: Text(
              PriceConverter.convertPrice(orders.orderAmount),
              style: rubikMedium.copyWith(
                color: Get.isDarkMode
                    ? Theme.of(context).hintColor.withValues(alpha: .5)
                    : Theme.of(context).primaryColor,
