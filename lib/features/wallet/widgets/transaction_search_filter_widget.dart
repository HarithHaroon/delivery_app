...
import 'package:rawabit_delivery_app/common/basewidgets/custom_calender_widget.dart';
            ...
            SizedBox(
              ...
              child: CustomCalendarWidget(
                onSubmit: (PickerDateRange? range) {
                  walletController.selectDate(
                    startDate: DateConverter.dateStringMonthYear(
                      range?.startDate,
                    ),
                    endDate: DateConverter.dateStringMonthYear(range?.endDate),
                  );
                              ...
                              CustomCalendarWidget(
                                onSubmit: (PickerDateRange? range) {
                                  walletController.selectDate(
                                    ...
                                    endDate: DateConverter.dateStringMonthYear(
                                      range?.endDate,
                                    ),
                                  );
