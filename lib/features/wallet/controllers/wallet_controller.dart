...
class WalletController extends GetxController implements GetxService {
  ...
  Future getOrderWiseDeliveryCharge(
    String startDate,
    String endDate,
    int offset,
    String type, {
    ...
    _deliveryWiseEarned = await walletServiceInterface.getDeliveryWiseEarned(
      startDate: startDate,
      endDate: endDate,
      offset: offset,
      type: type,
  ...
  Future<void> getDepositedList(
    ...
    _depositedList = await walletServiceInterface.getDepositedList(
      startDate: startDate,
      endDate: endDate,
      offset: offset,
      type: type,
