...
import 'package:rawabit_delivery_app/common/basewidgets/custom_botom_navy_bar_widget.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    if ((orderController.allOrderHistory == null ||
            orderController.allOrderHistory!.isEmpty) &&
        (orderController.pauseOrderHistory == null ||
            orderController.pauseOrderHistory!.isEmpty) &&
        (orderController.deliveredOrderHistory == null ||
            orderController.deliveredOrderHistory!.isEmpty)) {
      Get.find<OrderController>().getAllOrderHistory('', '', '', '', '', 0);
    }

    if (widget.pageIndex == 2) {
      Get.find<DashboardController>().selectConversationScreen(
        isUpdate: false,
