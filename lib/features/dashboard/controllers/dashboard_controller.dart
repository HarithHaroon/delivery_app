...
import 'package:rawabit_delivery_app/features/chat/screens/conversation_screen.dart';
import 'package:rawabit_delivery_app/features/home/screens/home_screen.dart';
import 'package:rawabit_delivery_app/features/notification/screens/notification_screen.dart';
import 'package:rawabit_delivery_app/features/order/screens/order_history_screen.dart';
import 'package:rawabit_delivery_app/features/profile/screens/profile_screen.dart';
...
class DashboardController extends GetxController implements GetxService {
  ...
  void selectConversationScreen({bool isUpdate = true, int? chatIndex}) {
    _currentScreen = ConversationScreen(
      fromNotification: !isUpdate,
      chatIndex: chatIndex,
    );
    _currentTab = 2;
    if (isUpdate) {
